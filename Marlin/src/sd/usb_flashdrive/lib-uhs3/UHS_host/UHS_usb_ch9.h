...
#define                USB_SETUP_RECIPIENT_PORT 0x04    // Wireless USB 1.0//无线USB 1.0
#define               USB_SETUP_RECIPIENT_RPIPE 0x05    // Wireless USB 1.0//无线USB 1.0
...
// Conventional codes for class-specific descriptors. "Common Class" Spec (3.11)//类特定描述符的常规代码。“普通级”规范（3.11）
...
#define               USB_TRANSFER_DIRECTION_IN 0x80    // Indicate direction is IN//指示方向在哪
