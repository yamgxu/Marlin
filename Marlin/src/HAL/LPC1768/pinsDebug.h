...
#define pwm_details(pin) pin = pin    // do nothing  // print PWM details//不执行任何操作//打印PWM详细信息
...
// pins that will cause hang/reset/disconnect in M43 Toggle and Watch utilities//导致M43切换和监视实用程序中挂起/复位/断开的针脚
  ...
  #define M43_NEVER_TOUCH(Q) ((Q) == P0_29 || (Q) == P0_30 || (Q) == P2_09)  // USB pins//USB插脚
#endif

bool GET_PINMODE(const pin_t pin) {
  if (!LPC176x::pin_is_valid(pin) || LPC176x::pin_adc_enabled(pin)) // found an invalid pin or active analog pin//发现无效的pin或活动的模拟pin
    return false;
