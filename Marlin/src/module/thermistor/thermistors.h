...
// Currently Marlin stores all oversampled ADC values as int16_t, make sure the HAL settings do not overflow 15bit//目前，Marlin将所有过采样ADC值存储为int16\t，确保HAL设置不会溢出15位
...
// Pt1000 and Pt100 handling//Pt1000和Pt100处理
////
// Rt=R0*(1+a*T+b*T*T) [for T>0]//Rt=R0*（1+a*T+b*T*T）[对于T>0]
...
#if ANY_THERMISTOR_IS(1) // beta25 = 4092 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "EPCOS"//beta25=4092 K，R25=100千欧，上拉=4.7千欧，“EPCOS”
  #include "thermistor_1.h"
#endif
#if ANY_THERMISTOR_IS(2) // 4338 K, R25 = 200 kOhm, Pull-up = 4.7 kOhm, "ATC Semitec 204GT-2"//4338 K，R25=200千欧，上拉=4.7千欧，“ATC Semitec 204GT-2”
  #include "thermistor_2.h"
#endif
#if ANY_THERMISTOR_IS(3) // beta25 = 4120 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Mendel-parts"//beta25=4120 K，R25=100千欧，上拉=4.7千欧，“孟德尔零件”
  #include "thermistor_3.h"
#endif
#if ANY_THERMISTOR_IS(4) // beta25 = 3950 K, R25 = 10 kOhm, Pull-up = 4.7 kOhm, "Generic"//beta25=3950 K，R25=10千欧，上拉=4.7千欧，“通用”
  #include "thermistor_4.h"
#endif
#if ANY_THERMISTOR_IS(5) // beta25 = 4267 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "ParCan, ATC 104GT-2"//beta25=4267千欧，R25=100千欧，上拉=4.7千欧，“帕坎，ATC 104GT-2”
  #include "thermistor_5.h"
#endif
#if ANY_THERMISTOR_IS(501) // 100K Zonestar thermistor//100K Zonestar热敏电阻器
  #include "thermistor_501.h"
#endif
#if ANY_THERMISTOR_IS(502) // Unknown thermistor used by the Zonestar Průša P802M hot bed//Zonestar Průša P802M热床使用的未知热敏电阻
  #include "thermistor_502.h"
#endif
#if ANY_THERMISTOR_IS(503) // Zonestar (Z8XM2) Heated Bed thermistor//Zonestar（Z8XM2）加热床热敏电阻
  #include "thermistor_503.h"
#endif
#if ANY_THERMISTOR_IS(512) // 100k thermistor in RPW-Ultra hotend, Pull-up = 4.7 kOhm, "unknown model"//RPW Ultra hotend中的100k热敏电阻，上拉=4.7千欧，“未知型号”
  #include "thermistor_512.h"
#endif
#if ANY_THERMISTOR_IS(6) // beta25 = 4092 K, R25 = 100 kOhm, Pull-up = 8.2 kOhm, "EPCOS ?"//beta25=4092 K，R25=100千欧，上拉=8.2千欧，“EPCOS？”
  #include "thermistor_6.h"
#endif
#if ANY_THERMISTOR_IS(7) // beta25 = 3974 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Honeywell 135-104LAG-J01"//beta25=3974 K，R25=100千欧，上拉=4.7千欧，“霍尼韦尔135-104LAG-J01”
  #include "thermistor_7.h"
#endif
#if ANY_THERMISTOR_IS(71) // beta25 = 3974 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Honeywell 135-104LAF-J01"//beta25=3974 K，R25=100千欧，上拉=4.7千欧，“霍尼韦尔135-104LAF-J01”
  #include "thermistor_71.h"
#endif
#if ANY_THERMISTOR_IS(8) // beta25 = 3950 K, R25 = 100 kOhm, Pull-up = 10 kOhm, "Vishay E3104FHT"//beta25=3950 K，R25=100千欧，上拉=10千欧，“Vishay E3104FHT”
  #include "thermistor_8.h"
#endif
#if ANY_THERMISTOR_IS(9) // beta25 = 3960 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "GE Sensing AL03006-58.2K-97-G1"//beta25=3960 K，R25=100千欧，上拉=4.7千欧，“GE传感AL03006-58.2K-97-G1”
  #include "thermistor_9.h"
#endif
#if ANY_THERMISTOR_IS(10) // beta25 = 3960 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "RS 198-961"//beta25=3960千欧，R25=100千欧，上拉=4.7千欧，“RS 198-961”
  #include "thermistor_10.h"
#endif
#if ANY_THERMISTOR_IS(11) // beta25 = 3950 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "QU-BD silicone bed, QWG-104F-3950"//beta25=3950 K，R25=100千欧，上拉=4.7千欧，“QU-BD硅胶床，QWG-104F-3950”
  #include "thermistor_11.h"
#endif
#if ANY_THERMISTOR_IS(13) // beta25 = 4100 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Hisens"//beta25=4100 K，R25=100千欧，上拉=4.7千欧，“嘶嘶声”
  #include "thermistor_13.h"
#endif
#if ANY_THERMISTOR_IS(15) // JGAurora A5 thermistor calibration//JGAurora A5热敏电阻校准
  #include "thermistor_15.h"
#endif
#if ANY_THERMISTOR_IS(17) // Dagoma NTC 100k white thermistor//达戈马NTC 100k白色热敏电阻
  #include "thermistor_17.h"
#endif
#if ANY_THERMISTOR_IS(18) // ATC Semitec 204GT-2 (4.7k pullup) Dagoma.Fr - MKS_Base_DKU001327//ATC Semitec 204GT-2（4.7k上拉）达戈马Fr-MKS_基地DKU001327
  #include "thermistor_18.h"
#endif
#if ANY_THERMISTOR_IS(20) // Pt100 with INA826 amp on Ultimaker v2.0 electronics//Ultimaker v2.0电子设备上配备INA826放大器的Pt100
  #include "thermistor_20.h"
#endif
#if ANY_THERMISTOR_IS(21) // Pt100 with INA826 amp with 3.3v excitation based on "Pt100 with INA826 amp on Ultimaker v2.0 electronics"//基于“Ultimaker v2.0电子设备上带有INA826放大器的Pt100，带3.3v励磁”
  #include "thermistor_21.h"
#endif
#if ANY_THERMISTOR_IS(22) // Thermistor in a Rostock 301 hot end, calibrated with a multimeter//罗斯托克301热端的热敏电阻，用万用表校准
  #include "thermistor_22.h"
#endif
#if ANY_THERMISTOR_IS(23) // By AluOne #12622. Formerly 22 above. May need calibration/checking.//作者：阿鲁尼#12622。以前为上文第22段。可能需要校准/检查。
  #include "thermistor_23.h"
#endif
#if ANY_THERMISTOR_IS(30) // Kis3d Silicone mat 24V 200W/300W with 6mm Precision cast plate (EN AW 5083)//Kis3d硅垫24V 200W/300W，带6mm精密铸板（EN AW 5083）
  #include "thermistor_30.h"
#endif
#if ANY_THERMISTOR_IS(51) // beta25 = 4092 K, R25 = 100 kOhm, Pull-up = 1 kOhm, "EPCOS"//beta25=4092 K，R25=100千欧，上拉=1千欧，“EPCOS”
  #include "thermistor_51.h"
#endif
#if ANY_THERMISTOR_IS(52) // beta25 = 4338 K, R25 = 200 kOhm, Pull-up = 1 kOhm, "ATC Semitec 204GT-2"//beta25=4338 K，R25=200千欧，上拉=1千欧，“ATC Semitec 204GT-2”
  #include "thermistor_52.h"
#endif
#if ANY_THERMISTOR_IS(55) // beta25 = 4267 K, R25 = 100 kOhm, Pull-up = 1 kOhm, "ATC Semitec 104GT-2 (Used on ParCan)"//beta25=4267 K，R25=100千欧，上拉=1千欧，“ATC Semitec 104GT-2（用于ParCan）”
  #include "thermistor_55.h"
#endif
#if ANY_THERMISTOR_IS(60) // beta25 = 3950 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Maker's Tool Works Kapton Bed"//beta25=3950 K，R25=100千欧，上拉=4.7千欧，“制造商的工具在卡普顿床上工作”
  #include "thermistor_60.h"
#endif
#if ANY_THERMISTOR_IS(61) // beta25 = 3950 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Formbot 350°C Thermistor"//beta25=3950 K，R25=100千欧，上拉=4.7千欧，“Formbot 350°C热敏电阻”
  #include "thermistor_61.h"
#endif
#if ANY_THERMISTOR_IS(66) // beta25 = 4500 K, R25 = 2.5 MOhm, Pull-up = 4.7 kOhm, "DyzeDesign 500 °C Thermistor"//beta25=4500 K，R25=2.5 MOhm，上拉=4.7 kOhm，“DyzeDesign 500°C热敏电阻”
  #include "thermistor_66.h"
#endif
#if ANY_THERMISTOR_IS(67) // R25 = 500 KOhm, beta25 = 3800 K, 4.7 kOhm pull-up, SliceEngineering 450 °C Thermistor//R25=500千欧，beta25=3800千欧，4.7千欧上拉，450°C热敏电阻
  #include "thermistor_67.h"
#endif
#if ANY_THERMISTOR_IS(12) // beta25 = 4700 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Personal calibration for Makibox hot bed"//beta25=4700 K，R25=100千欧，上拉=4.7千欧，“Makibox热床的个人校准”
  #include "thermistor_12.h"
#endif
#if ANY_THERMISTOR_IS(70) // beta25 = 4100 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "Hephestos 2, bqh2 stock thermistor"//beta25=4100 K，R25=100千欧，上拉=4.7千欧，“Hephestos 2，bqh2库存热敏电阻”
  #include "thermistor_70.h"
#endif
#if ANY_THERMISTOR_IS(75) // beta25 = 4100 K, R25 = 100 kOhm, Pull-up = 4.7 kOhm, "MGB18-104F39050L32 thermistor"//beta25=4100 K，R25=100千欧，上拉=4.7千欧，“MGB18-104F39050L32热敏电阻”
  #include "thermistor_75.h"
#endif
#if ANY_THERMISTOR_IS(99) // 100k bed thermistor with a 10K pull-up resistor (on some Wanhao i3 models)//带10K上拉电阻器的100k床用热敏电阻器（在一些万豪i3型号上）
  #include "thermistor_99.h"
#endif
#if ANY_THERMISTOR_IS(110) // Pt100 with 1k0 pullup//Pt100带1k0上拉
  #include "thermistor_110.h"
#endif
#if ANY_THERMISTOR_IS(147) // Pt100 with 4k7 pullup//Pt100带4k7上拉
  #include "thermistor_147.h"
#endif
#if ANY_THERMISTOR_IS(201) // Pt100 with LMV324 Overlord//带LMV324霸王的Pt100
  #include "thermistor_201.h"
#endif
#if ANY_THERMISTOR_IS(202) // 200K thermistor in Copymaker3D hotend//Copymaker3D热端中的200K热敏电阻
  #include "thermistor_202.h"
#endif
#if ANY_THERMISTOR_IS(331) // Like table 1, but with 3V3 as input voltage for MEGA//与表1类似，但使用3V3作为MEGA的输入电压
  #include "thermistor_331.h"
#endif
#if ANY_THERMISTOR_IS(332) // Like table 1, but with 3V3 as input voltage for DUE//与表1类似，但使用3V3作为到期的输入电压
  #include "thermistor_332.h"
#endif
#if ANY_THERMISTOR_IS(666) // beta25 = UNK, R25 = 200K, Pull-up = 10 kOhm, "Unidentified 200K NTC thermistor (Einstart S)"//beta25=UNK，R25=200K，上拉=10千欧，“不明200K NTC热敏电阻（Einstart S）”
  #include "thermistor_666.h"
#endif
#if ANY_THERMISTOR_IS(1010) // Pt1000 with 1k0 pullup//Pt1000带1k0上拉
  #include "thermistor_1010.h"
#endif
#if ANY_THERMISTOR_IS(1047) // Pt1000 with 4k7 pullup//带4k7上拉的Pt1000
  #include "thermistor_1047.h"
#endif
#if ANY_THERMISTOR_IS(998) // User-defined table 1//用户定义表1
  #include "thermistor_998.h"
#endif
#if ANY_THERMISTOR_IS(999) // User-defined table 2//用户定义表2
  #include "thermistor_999.h"
#endif
#if ANY_THERMISTOR_IS(1000) // Custom//习俗
...
// The SCAN_THERMISTOR_TABLE macro needs alteration?//扫描热敏电阻表宏是否需要更改？
...
// Set the high and low raw values for the heaters//设置加热器的高和低原始值
// For thermistors the highest temperature results in the lowest ADC value//对于热敏电阻，最高温度导致最低ADC值
// For thermocouples the highest temperature results in the highest ADC value//对于热电偶，最高温度产生最高ADC值
