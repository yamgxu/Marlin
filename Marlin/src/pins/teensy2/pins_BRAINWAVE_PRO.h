...
// Limit Switches//限位开关
////
#define X_STOP_PIN                            45  // F7//F7
#define Y_STOP_PIN                            12  // C2//C2
...
////
  ...
  #define Z_MIN_PROBE_PIN                     11  // C1//C1
#endif

////
// Steppers//踏步机
////
#define X_STEP_PIN                             9  // E1//E1
#define X_DIR_PIN                              8  // E0//E0
#define X_ENABLE_PIN                          23  // B3//B3

#define Y_STEP_PIN                             7  // D7//D7
#define Y_DIR_PIN                              6  // D6//D6
#define Y_ENABLE_PIN                          20  // B0//B0

#define Z_STEP_PIN                             5  // D5//D5
#define Z_DIR_PIN                              4  // D4//D4
#define Z_ENABLE_PIN                          37  // E5//E5

#define E0_STEP_PIN                           47  // E3//E3
#define E0_DIR_PIN                            46  // E2//E2
#define E0_ENABLE_PIN                         25  // B5//B5

////
// Temperature Sensors//温度传感器
////
#define TEMP_0_PIN                             2  // F2  Analog Input//模拟输入
#define TEMP_1_PIN                             1  // F1  Analog Input//F1模拟输入
#define TEMP_BED_PIN                           0  // F0  Analog Input//模拟输入

////
// Heaters / Fans//加热器/风扇
////
#define HEATER_0_PIN                          27  // B7//B7
#define HEATER_BED_PIN                        26  // B6  Bed//B6床
#ifndef FAN_PIN
  #define FAN_PIN                             16  // C6  Fan, PWM3A//C6风扇，PWM3A
#endif
...
#define SD_DETECT_PIN                         24  // B4//B4
#define LED_PIN                               13  // C3//C3
