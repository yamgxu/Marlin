...
// Disable JTAG pins so they can be used for the Extrudrboard//禁用JTAG引脚，以便它们可用于挤出板
#define DISABLE_JTAG
...
#define Y_STOP_PIN                            20  // B0 SS//B0不锈钢
...
#define HEATER_1_PIN                          44  // F6//F6
#define HEATER_2_PIN                          45  // F7//F7
...
////
  ...
  #define LCD_PINS_D7                          4  // D4       JP11-5//D4 JP11-5
    ...
    #define SDSS                              43  // F5 TMS   JP2-8//F5 TMS JP2-8
    ...
    #define BTN_EN1                            3  // D3 RX1   JP2-7//D3 RX1 JP2-7
    #define BTN_EN2                            2  // D2 TX1   JP2-5//D2 TX1 JP2-5
    #define BTN_ENC                           41  // F3       JP2-4//F3 JP2-4

    #define SDSS                              38  // F0       B-THERM connector - use SD card on Panelolu2//F0 B-THERM连接器-使用Panelolu2上的SD卡
...
#ifndef SDSS
  #define SDSS                                26  // B6 SDCS//B6 SDCS
#endif
