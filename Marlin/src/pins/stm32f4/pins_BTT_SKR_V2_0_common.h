...
////
#define X_DIAG_PIN                          PC1   // X-STOP//X光圈
#define Y_DIAG_PIN                          PC3   // Y-STOP//Y形挡块
#define Z_DIAG_PIN                          PC0   // Z-STOP//Z-STOP
#define E0_DIAG_PIN                         PC2   // E0DET//E0DET
#define E1_DIAG_PIN                         PA0   // E1DET//E1DET
...
////
  ...
  #if X_HOME_TO_MIN
    #define X_MAX_PIN                       PC2   // E0DET//E0DET
  #else
    #define X_MIN_PIN                       PC2   // E0DET//E0DET
  #endif
#elif ENABLED(X_DUAL_ENDSTOPS)
  #ifndef X_MIN_PIN
    #define X_MIN_PIN                       PC1   // X-STOP//X光圈
  #endif
  #ifndef X_MAX_PIN
    #define X_MAX_PIN                       PC2   // E0DET//E0DET
  #endif
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                       PA0   // E1DET//E1DET
  #else
    #define Y_MIN_PIN                       PA0   // E1DET//E1DET
  #endif
#elif ENABLED(Y_DUAL_ENDSTOPS)
  #ifndef Y_MIN_PIN
    #define Y_MIN_PIN                       PC3   // Y-STOP//Y形挡块
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                       PA0   // E1DET//E1DET
  #endif
#else
  #define Y_STOP_PIN                        PC3   // Y-STOP//Y形挡块
#endif

#ifdef Z_STALL_SENSITIVITY
  #define Z_STOP_PIN                  Z_DIAG_PIN
  #if Z_HOME_TO_MIN
    #define Z_MAX_PIN                       PC15  // PWRDET//普尔德特
  #else
    #define Z_MIN_PIN                       PC15  // PWRDET//普尔德特
  #endif
#elif ENABLED(Z_MULTI_ENDSTOPS)
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                       PC0   // Z-STOP//Z-STOP
  #endif
  #ifndef Z_MAX_PIN
    #define Z_MAX_PIN                       PC15  // PWRDET//普尔德特
  #endif
#else
  #ifndef Z_STOP_PIN
    #define Z_STOP_PIN                      PC0   // Z-STOP//Z-STOP
  #endif
#endif
...
////
#define FIL_RUNOUT_PIN                      PC2   // E0DET//E0DET
#define FIL_RUNOUT2_PIN                     PA0   // E1DET//E1DET

////
// Power Supply Control//电源控制
////
#ifndef PS_ON_PIN
  #define PS_ON_PIN                         PE8   // PS-ON//PS-ON
#endif
...
////
  ...
  #define POWER_LOSS_PIN                    PC15  // PWRDET//普尔德特
#endif
...
////
// Control pin of driver/heater/fan power supply//驱动器/加热器/风扇电源的控制引脚
////
...
////
#ifndef HEATER_0_PIN
  #define HEATER_0_PIN                      PB3   // Heater0//加热器
#endif
#ifndef HEATER_1_PIN
  #define HEATER_1_PIN                      PB4   // Heater1//加热器1
#endif
#ifndef HEATER_BED_PIN
  #define HEATER_BED_PIN                    PD7   // Hotbed//温床
#endif
#ifndef FAN_PIN
  #define FAN_PIN                           PB7   // Fan0//Fan0
#endif
#ifndef FAN1_PIN
  #define FAN1_PIN                          PB6   // Fan1//Fan1
#endif
#ifndef FAN2_PIN
  #define FAN2_PIN                          PB5   // Fan2//风扇2
#endif
