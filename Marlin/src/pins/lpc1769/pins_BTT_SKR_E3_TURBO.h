...
#define I2C_EEPROM
#define MARLIN_EEPROM_SIZE                0x1000  // 4KB (AT24C32)//4KB（AT24C32）
...
////
  ...
  #define POWER_LOSS_PIN                   P1_20  // PWRDET//普尔德特
#endif
...
////
// TMC Low Power Standby pins//TMC低功耗备用引脚
////
...
//#define TEMP_2_PIN                       P1_30  // Onboard thermistor//#定义温度2引脚P1\U 30//板载热敏电阻
#define TEMP_BED_PIN                       P0_25

////
// Heaters / Fans//加热器/风扇
////
#define HEATER_0_PIN                       P2_03  // EXTRUDER 0//挤出机0
#define HEATER_1_PIN                       P2_04  // EXTRUDER 1//挤出机1
#define HEATER_BED_PIN                     P2_05  // BED//床
...
#define EXP1_10_PIN                        P2_08
  ...
  #define BTN_ENC                    EXP1_06_PIN
    ...
    #define ADC_KEYPAD_PIN                 P1_23  // Repurpose servo pin for ADC - CONNECTING TO 5V WILL DAMAGE THE BOARD!//将伺服引脚重新用于ADC-连接到5V会损坏电路板！
