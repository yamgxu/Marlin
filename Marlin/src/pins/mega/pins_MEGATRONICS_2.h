...
#define Y_STEP_PIN                             4  // A6//A6
#define Y_DIR_PIN                             54  // A0//A0
#define Y_ENABLE_PIN                           5

#define Z_STEP_PIN                            56  // A2//A2
#define Z_DIR_PIN                             60  // A6//A6
#define Z_ENABLE_PIN                          55  // A1//A1
...
#define E2_STEP_PIN                           23  // ? schematic says 24// ? 示意图是24
#define E2_DIR_PIN                            24  // ? schematic says 23// ? 示意图是23
...
#if TEMP_SENSOR_1 == -1
  #define TEMP_1_PIN                           8  // Analog Input//模拟输入
#else
...
#define SPINDLE_LASER_ENA_PIN                 16  // Pullup!//拉起！
...
#define BEEPER_PIN                            64
  ...
  #define LCD_PINS_D7                         33
    ...
    #define BTN_ENC                           43
  #else
    // Buttons attached to shift register of reprapworld keypad v1.1//连接到reprapworld键盘v1.1移位寄存器的按钮
