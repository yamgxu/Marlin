...
#define TEMP_BED_PIN                           4  // Analog Input//模拟输入
  ...
  #define TEMP_CHAMBER_PIN                     5  // Analog Input//模拟输入
#endif
...
#define AUTO_FAN_PIN                          30
  ...
  //#define CHAMBER_AUTO_FAN_PIN              10//#定义腔室自动风扇针脚10
#endif
