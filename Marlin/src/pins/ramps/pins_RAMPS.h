...
////
  ...
  #define MAX6675_SS_PIN                      66  // Don't use 53 if using Display/SD card (SDSS) or 49 (SD_DETECT_PIN)//如果使用显示器/SD卡（SDSS）或49（SDU检测引脚），则不要使用53
#endif
...
// RAMPS 1.4 DIO 4 on the servos connector//伺服连接器上的斜坡1.4 DIO 4
...
////
// Aux 3 GND D52 D50 5V//辅助3接地D52 D50 5V
//       NC  D53 D51 D49//NC D53 D51 D49

////
// Aux 4 D16 D17 D23 D25 D27 D29 D31 D33 D35 D37 D39 D41 D43 D45 D47 D32 GND 5V//辅助4 D16 D17 D23 D25 D27 D29 D31 D33 D35 D37 D39 D41 D43 D45 D47 D32接地5V
////
...
//#define LCD_SCREEN_ROT_270//#定义LCD屏幕旋转270
  ...
  ////
    ...
    #define LCD_PINS_RS              EXP2_04_PIN  // CS chip select /SS chip slave select//CS芯片选择/SS芯片从属选择
    #define LCD_PINS_ENABLE          EXP2_05_PIN  // SID (MOSI)//SID（MOSI）
    #define LCD_PINS_D4              EXP2_09_PIN  // SCK (CLK) clock//时钟
    ...
    #define TFTGLCD_CS               EXP2_06_PIN
      ...
      #define LCD_PINS_D7                     65
        ...
        #define LCD_PINS_DC          EXP1_05_PIN  // Set as output on init//在init上设置为输出
        #define LCD_PINS_RS          EXP1_04_PIN  // Pull low for 1s to init//拉低1s至初始
      ...
      //#define SHIFT_EN_PIN         EXP1_08_PIN//#定义SHIFT_EN_引脚EXP1_08_引脚
    #endif
  ...
  ////
      ...
      #define BTN_EN1                         40  // https://files.panucatt.com/datasheets/viki_wiring_diagram.pdf explains 40/42.// https://files.panucatt.com/datasheets/viki_wiring_diagram.pdf 解释40/42。
      #define BTN_EN2                         42
      #define BTN_ENC                         -1
      ...
      #define SD_DETECT_PIN          EXP2_04_PIN
        ...
        #define LCD_BACKLIGHT_PIN             -1  // 65 (MKS mini12864 can't adjust backlight by software!)//65（MKS mini12864无法通过软件调整背光！）
