...
#define LED_PIN                                8
#define SAFETY_TRIGGERED_PIN                  28  // PIN to detect the safety circuit has triggered//用于检测安全电路的针脚已触发
#define MAIN_VOLTAGE_MEASURE_PIN              14  // ANALOG PIN to measure the main voltage, with a 100k - 4k7 resitor divider.//模拟引脚测量主电压，带有100k-4k7电阻分压器。
...
////
#if HAS_CUTTER                                    // use the LED_PIN for spindle speed control or case light//将LED_引脚用于主轴速度控制或箱灯
  #undef LED_PIN
  #define SPINDLE_DIR_PIN                     16
  #define SPINDLE_LASER_ENA_PIN               17  // Pullup!//拉起！
  #define SPINDLE_LASER_PWM_PIN                8  // Hardware PWM//硬件脉宽调制
#else
  #undef LED_PIN
