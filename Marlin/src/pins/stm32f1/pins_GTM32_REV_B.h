...
////
// Heaters / Fans - INFO: Extruders ports are in reverse order. Pin numbers here differ from schematic. Original firmware assumes heater, fan and temp sensor on port EXT0 PB0, PB9, PC2.//加热器/风扇-信息：挤出机端口顺序相反。此处的管脚编号与示意图不同。原始固件假定加热器、风扇和温度传感器位于端口EXT0 PB0、PB9、PC2上。
////
...
////
    ...
    ////
    #define LCD_PINS_RS                     PA12  // CS chip select /SS chip slave select//CS芯片选择/SS芯片从属选择
    // RW is hardwired to VSS//RW硬连线到VSS
    #define LCD_PINS_ENABLE                 PC7   // SID (MOSI)//SID（MOSI）
    #define LCD_PINS_D4                     PD1   // SCK (CLK) clock//时钟
    ...
    //#define GTM32_PRO_VB_USE_LCD_BEEPER//#定义GTM32_PRO_VB_使用_LCD_蜂鸣器
 ...
 */
  ...
  ////
  #define SD_SS_PIN                         PB12  // PC11//PC11
  #define SD_SCK_PIN                        PB13  // PC12 // PC1//PC12//PC1
  #define SD_MOSI_PIN                       PB15  // PD2  // PD2//PD2//PD2
  #define SD_MISO_PIN                       PB14  // PC8//PC8
  ...
  #define SD_MISO_PIN                       PA6   // PA6//尼龙6
