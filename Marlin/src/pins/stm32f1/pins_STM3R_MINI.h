...
//#define HEATER_1_PIN                      PD13//#定义加热器1引脚PD13

#define HEATER_BED_PIN                      PB9   // BED//床
//#define HEATER_BED2_PIN                   -1    // BED2//#定义加热器底座2的针脚-1//底座2
//#define HEATER_BED3_PIN                   -1    // BED3//#定义加热器底座3的针脚-1//底座3
...
////
    ...
    #define TOUCH_CS_PIN                    PB12  // SPI2_NSS//SPI2\U NSS
    #define TOUCH_SCK_PIN                   PB13
    #define TOUCH_MOSI_PIN                  PB14
    #define TOUCH_MISO_PIN                  PB15
    #define TOUCH_INT_PIN                   PC6   // (PenIRQ coming from ADS7843)//（PenIRQ来自ADS7843）
