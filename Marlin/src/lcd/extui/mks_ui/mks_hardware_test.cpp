...
void mks_hardware_test() {
    ...
    if (millis() % 2000 < 1000) {
      ...
      #if !MB(MKS_ROBIN_E3P)
        WRITE(HEATER_1_PIN, HIGH); // HE1//呵呵
      #endif
      WRITE(HEATER_0_PIN, HIGH); // HE0//他
      WRITE(HEATER_BED_PIN, HIGH); // HOT-BED//热床
    }
    else {
      ...
      #if !MB(MKS_ROBIN_E3P)
        WRITE(HEATER_1_PIN, LOW); // HE1//呵呵
      #endif
      WRITE(HEATER_0_PIN, LOW); // HE0//他
      WRITE(HEATER_BED_PIN, LOW); // HOT-BED//热床
    }
