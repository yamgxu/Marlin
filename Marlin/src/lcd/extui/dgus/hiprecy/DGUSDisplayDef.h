...
//constexpr uint16_t VP_E1_BED_PREHEAT = 0x2222;//constexpr uint16\u t VP\u E1\u床层预热=0x2222；
//constexpr uint16_t VP_E2_BED_PREHEAT = 0x2224;//constexpr uint16\u t VP\u E2\u床层预热=0x2224；
//constexpr uint16_t VP_E3_BED_PREHEAT = 0x2226;//constexpr uint16\u t VP\u E3\u床层预热=0x2226；
//constexpr uint16_t VP_E4_BED_PREHEAT = 0x2228;//constexpr uint16\u t VP\u E4\u床层预热=0x2228；
//constexpr uint16_t VP_E5_BED_PREHEAT = 0x222A;//constexpr uint16\u t VP\u E5\u床层预热=0x222A；
...
// First layer cal//第一层校准
constexpr uint16_t VP_Z_FIRST_LAYER_CAL = 0x2500; // Data: 0 - Cancel first layer cal progress, >0 filament type have loaded//数据：0-取消第一层校准进度，>0灯丝类型已加载
...
//constexpr uint16_t VP_T_E2_Set = 0x306A; // 2 Byte Integer//constexpr uint16\u t VP\u t\u E2\u集=0x306A；//2字节整数
//constexpr uint16_t VP_T_E3_Is = 0x306C;  // 4 Byte Integer//constexpr uint16\u t VP\u t\u E3\u Is=0x306C；//4字节整数
//constexpr uint16_t VP_T_E3_Set = 0x306E; // 2 Byte Integer//constexpr uint16\u t VP\u t\u E3\u集=0x306E；//2字节整数
//constexpr uint16_t VP_T_E4_Is = 0x3070;  // 4 Byte Integer//constexpr uint16\u t VP\u t\u E4\u Is=0x3070；//4字节整数
//constexpr uint16_t VP_T_E4_Set = 0x3072; // 2 Byte Integer//constexpr uint16\u t VP\u t\u E4\u集=0x3072；//2字节整数
...
constexpr uint16_t VP_Fan1_Percentage = 0x3102;  // 2 Byte Integer (0..100)//2字节整数（0..100）
constexpr uint16_t VP_Fan2_Percentage = 0x3104;  // 2 Byte Integer (0..100)//2字节整数（0..100）
constexpr uint16_t VP_Fan3_Percentage = 0x3106;  // 2 Byte Integer (0..100)//2字节整数（0..100）
constexpr uint16_t VP_Feedrate_Percentage = 0x3108; // 2 Byte Integer (0..100)//2字节整数（0..100）
...
constexpr uint16_t VP_PrintProgress_Percentage = 0x3130; // 2 Byte Integer (0..100)//2字节整数（0..100）
