...
static const uxg_fontinfo_t g_fontinfo[] PROGMEM = {
    FONTDATA_ITEM(2, 140, 143, fontpage_2_140_143), // 'Č' -- 'ď'// 'Č' -- 'ď'
    FONTDATA_ITEM(2, 186, 186, fontpage_2_186_186), // 'ĺ' -- 'ĺ'// 'ĺ' -- 'ĺ'
    FONTDATA_ITEM(2, 189, 190, fontpage_2_189_190), // 'Ľ' -- 'ľ'// 'Ľ' -- 'ľ'
    FONTDATA_ITEM(2, 199, 200, fontpage_2_199_200), // 'Ň' -- 'ň'// 'Ň' -- 'ň'
