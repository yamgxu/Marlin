...
static const uxg_fontinfo_t g_fontinfo[] PROGMEM = {
    FONTDATA_ITEM(2, 131, 131, fontpage_2_131_131), // 'ă' -- 'ă'// 'ă' -- 'ă'
    FONTDATA_ITEM(2, 144, 145, fontpage_2_144_145), // 'Đ' -- 'đ'// 'Đ' -- 'đ'
    FONTDATA_ITEM(2, 169, 169, fontpage_2_169_169), // 'ĩ' -- 'ĩ'// 'ĩ' -- 'ĩ'
    FONTDATA_ITEM(3, 161, 161, fontpage_3_161_161), // 'ơ' -- 'ơ'// 'ơ' -- 'ơ'
    FONTDATA_ITEM(3, 175, 176, fontpage_3_175_176), // 'Ư' -- 'ư'// 'Ư' -- 'ư'
    FONTDATA_ITEM(6, 131, 131, fontpage_6_131_131), // '̃' -- '̃'// '̃' -- '̃'
    FONTDATA_ITEM(6, 137, 137, fontpage_6_137_137), // '̉' -- '̉'// '̉' -- '̉'
    FONTDATA_ITEM(6, 163, 163, fontpage_6_163_163), // '̣' -- '̣'// '̣' -- '̣'
    FONTDATA_ITEM(6, 192, 193, fontpage_6_192_193), // '̀' -- '́'// '̀' -- '́'
    FONTDATA_ITEM(61, 161, 161, fontpage_61_161_161), // 'ạ' -- 'ạ'// 'ạ' -- 'ạ'
    FONTDATA_ITEM(61, 163, 163, fontpage_61_163_163), // 'ả' -- 'ả'// 'ả' -- 'ả'
    FONTDATA_ITEM(61, 165, 165, fontpage_61_165_165), // 'ấ' -- 'ấ'// 'ấ' -- 'ấ'
    FONTDATA_ITEM(61, 167, 167, fontpage_61_167_167), // 'ầ' -- 'ầ'// 'ầ' -- 'ầ'
    FONTDATA_ITEM(61, 169, 169, fontpage_61_169_169), // 'ẩ' -- 'ẩ'// 'ẩ' -- 'ẩ'
    FONTDATA_ITEM(61, 173, 173, fontpage_61_173_173), // 'ậ' -- 'ậ'// 'ậ' -- 'ậ'
    FONTDATA_ITEM(61, 175, 175, fontpage_61_175_175), // 'ắ' -- 'ắ'// 'ắ' -- 'ắ'
    FONTDATA_ITEM(61, 177, 177, fontpage_61_177_177), // 'ằ' -- 'ằ'// 'ằ' -- 'ằ'
    FONTDATA_ITEM(61, 179, 179, fontpage_61_179_179), // 'ẳ' -- 'ẳ'// 'ẳ' -- 'ẳ'
    FONTDATA_ITEM(61, 181, 181, fontpage_61_181_181), // 'ẵ' -- 'ẵ'// 'ẵ' -- 'ẵ'
    FONTDATA_ITEM(61, 183, 183, fontpage_61_183_183), // 'ặ' -- 'ặ'// 'ặ' -- 'ặ'
    FONTDATA_ITEM(61, 191, 191, fontpage_61_191_191), // 'ế' -- 'ế'// 'ế' -- 'ế'
    FONTDATA_ITEM(61, 193, 193, fontpage_61_193_193), // 'ề' -- 'ề'// 'ề' -- 'ề'
    FONTDATA_ITEM(61, 195, 195, fontpage_61_195_195), // 'ể' -- 'ể'// 'ể' -- 'ể'
    FONTDATA_ITEM(61, 199, 199, fontpage_61_199_199), // 'ệ' -- 'ệ'// 'ệ' -- 'ệ'
    FONTDATA_ITEM(61, 201, 201, fontpage_61_201_201), // 'ỉ' -- 'ỉ'// 'ỉ' -- 'ỉ'
    FONTDATA_ITEM(61, 203, 203, fontpage_61_203_203), // 'ị' -- 'ị'// 'ị' -- 'ị'
    FONTDATA_ITEM(61, 205, 205, fontpage_61_205_205), // 'ọ' -- 'ọ'// 'ọ' -- 'ọ'
    FONTDATA_ITEM(61, 207, 207, fontpage_61_207_207), // 'ỏ' -- 'ỏ'// 'ỏ' -- 'ỏ'
    FONTDATA_ITEM(61, 209, 209, fontpage_61_209_209), // 'ố' -- 'ố'// 'ố' -- 'ố'
    FONTDATA_ITEM(61, 211, 211, fontpage_61_211_211), // 'ồ' -- 'ồ'// 'ồ' -- 'ồ'
    FONTDATA_ITEM(61, 213, 213, fontpage_61_213_213), // 'ổ' -- 'ổ'// 'ổ' -- 'ổ'
    FONTDATA_ITEM(61, 215, 215, fontpage_61_215_215), // 'ỗ' -- 'ỗ'// 'ỗ' -- 'ỗ'
    FONTDATA_ITEM(61, 217, 217, fontpage_61_217_217), // 'ộ' -- 'ộ'// 'ộ' -- 'ộ'
    FONTDATA_ITEM(61, 219, 219, fontpage_61_219_219), // 'ớ' -- 'ớ'// 'ớ' -- 'ớ'
    FONTDATA_ITEM(61, 221, 221, fontpage_61_221_221), // 'ờ' -- 'ờ'// 'ờ' -- 'ờ'
    FONTDATA_ITEM(61, 223, 223, fontpage_61_223_223), // 'ở' -- 'ở'// 'ở' -- 'ở'
    FONTDATA_ITEM(61, 225, 225, fontpage_61_225_225), // 'ỡ' -- 'ỡ'// 'ỡ' -- 'ỡ'
    FONTDATA_ITEM(61, 227, 227, fontpage_61_227_227), // 'ợ' -- 'ợ'// 'ợ' -- 'ợ'
    FONTDATA_ITEM(61, 229, 229, fontpage_61_229_229), // 'ụ' -- 'ụ'// 'ụ' -- 'ụ'
    FONTDATA_ITEM(61, 231, 231, fontpage_61_231_231), // 'ủ' -- 'ủ'// 'ủ' -- 'ủ'
    FONTDATA_ITEM(61, 233, 233, fontpage_61_233_233), // 'ứ' -- 'ứ'// 'ứ' -- 'ứ'
    FONTDATA_ITEM(61, 235, 235, fontpage_61_235_235), // 'ừ' -- 'ừ'// 'ừ' -- 'ừ'
    FONTDATA_ITEM(61, 237, 237, fontpage_61_237_237), // 'ử' -- 'ử'// 'ử' -- 'ử'
    FONTDATA_ITEM(61, 239, 239, fontpage_61_239_239), // 'ữ' -- 'ữ'// 'ữ' -- 'ữ'
    FONTDATA_ITEM(61, 241, 241, fontpage_61_241_241), // 'ự' -- 'ự'// 'ự' -- 'ự'
};
